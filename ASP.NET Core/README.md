...
A quick start ASP.NET Core project that shows how to bind Elasticsearch Database to ASP.NET Core Pivot Table. This project contains client-side ASP.NET Core sample for syncfusion pivot table.
