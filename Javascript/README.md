...
A quick start javascript project that shows how to bind Elasticsearch Database to Javascript Pivot Table. This project contains client-side javascript sample for syncfusion pivot table.
